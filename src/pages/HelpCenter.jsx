...
const HelpCenter = ({ onLogout }) => {
  useEffect(() => {
    document.title = "Help Center | RollerAds";
  }, []);

  return (
    <div className="help-center-container">
      <Header routename="Help Center" onLogout={onLogout} />
      <div className="notification-container">
        ...
        <noscript>
          <a href="https://www.livechat.com/chat-with/18761115/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a>
        </noscript>
